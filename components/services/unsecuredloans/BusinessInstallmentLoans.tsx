...
import AnimatedWrapper from "@/components/AnimatedWrapper"; // ✅ shared animation wrapper
    ...
    <>
      <AnimatedWrapper>
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          <div className="relative w-full md:w-1/2 h-[500px] rounded shadow overflow-hidden">
            <Image
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base mb-6">
              Running a business comes with constant financial needs—whether it’s
              scaling operations, upgrading technology, hiring talent, or
              managing seasonal cash flow. At Nihal Finserv, our Business
              Instalment Loans provide fast, flexible funding with easy monthly
              EMIs, so you can focus on what matters most: growing your
              business.
            </p>
            <p className="text-base">
              We partner with top financial institutions to offer customised,
              collateral-free or secured loan options tailored to your business
              profile, ensuring quick approvals and minimal paperwork.
            </p>
          </div>
        </section>
      </AnimatedWrapper>
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p>
                A Business Instalment Loan is a term loan designed for
                entrepreneurs, SMEs, professionals, and self-employed
                individuals. Repayment is structured through monthly EMIs over a
                fixed tenure, giving you predictability and stability in managing
                business finances.
              </p>
            </div>
          </div>
        ...
        <section className="bg-[#132b4a] text-white px-8 py-16">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {[
                "Loan Amounts from ₹1 Lakh to ₹75 Lakhs",
                "Tenure Options from 12 to 60 Months",
                "Secured & Unsecured Loan Options Available",
                "Simple Documentation & Fast Disbursal",
                "Loans for Proprietorships, Partnerships, Pvt Ltd, LLPs",
                "Flexible EMI Structure to Match Cash Flow",
                "Boost Business Credit Score with Timely Repayments",
              ].map((feature, idx) => (
                <div key={idx} className="border border-gray-700 p-6">
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              Whether you're a startup or an established enterprise, funding
              should never hold you back. Let Nihal Finserv power your ambition
              with structured business loans that are as dynamic as your growth
              journey.
            </p>
