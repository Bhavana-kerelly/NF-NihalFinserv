        ...
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base mb-6">
              Quick, collateral-free funding for every need — from weddings to
              travel, education to emergencies.
            </p>
          </div>
        </section>
      </AnimatedWrapper>
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p>
                A Personal Loan is an unsecured loan that gives you the
                financial freedom to fulfill your personal goals without
                pledging any assets. Whether it’s a family wedding, medical
                emergency, travel, home renovation, or debt consolidation —
                Nihal Finserv connects you with top lenders offering fast
                approvals and easy EMIs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#132b4a] text-white px-8 py-16">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {[
                "Loan Amount 50000 to 40 Lakhs",
                "Loan Tenure 12 to 72 months",
                "Interest Rate Starting from 10.75% p.a.",
                "Approval Time is as fast as 24-48 hours",
                "Repayment is fixed EMIs via Auto Debit/NACH",
              ].map((feature, idx) => (
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              Nihal Finserv — Because your personal dreams deserve professional
              support.
            </p>
