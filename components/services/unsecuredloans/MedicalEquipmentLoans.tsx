...
export default function MedicalEquipmentLoans() {
  return (
    <>
      <AnimatedWrapper>
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base mb-6">
              Upgrading or acquiring advanced medical equipment is essential for
              better diagnosis, treatment, and patient care—but it often
              requires significant capital investment. At Nihal Finserv, we
              simplify this process by offering Medical Equipment Loans tailored
              specifically for healthcare professionals and institutions.
            </p>
            <p className="text-base">
              Whether you're setting up a new clinic, upgrading diagnostic
              machinery, or expanding hospital infrastructure, we provide fast,
              affordable, and flexible equipment loans to help you keep pace
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p>
                A Medical Equipment Loan is a specialised financial product
                designed for doctors, clinics, diagnostic centres, hospitals,
                and path labs to purchase or lease high-cost medical devices.
                These loans can cover equipment such as MRI machines, ultrasound
                devices, X-ray systems, dental chairs, operation theatre tools,
                and more.
              </p>
            </div>
          </div>
        ...
        <section className="bg-[#132b4a] text-white px-8 py-16">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {[
                "Credit Limit Based on Business Profile",
                "Up to 100% Equipment Financing",
                "Quick Approvals & Disbursal in 48–72 Hours",
                "Flexible Tenures up to 7 Years",
                "Collateral-Free Options Available",
                "EMI Options Based on Revenue Cycles",
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              From small clinics to large institutions, Nihal Finserv supports
              your medical excellence with smart financing.
            </p>
