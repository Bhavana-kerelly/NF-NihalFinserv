...
export default function EducationalLoans() {
  return (
    <>
      <AnimatedWrapper>
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base mb-6">
              Whether it’s India or abroad — fund your academic journey with
              smart education loans tailored to your needs.
            </p>
          </div>
        </section>
      </AnimatedWrapper>
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p>
                An Educational Loan is a specialized loan designed to finance
                the cost of higher education — including tuition, accommodation,
                books, travel, and living expenses. With Nihal Finserv, you can
                access a wide network of banks and NBFCs offering flexible
                education loans for undergraduate, postgraduate, vocational, and
                professional courses both in India and abroad.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#132b4a] text-white px-8 py-16">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {[
                "Loan Amount 50000 to 50 Lakhs",
                "Repayment Tenure up to 15 years",
                "Moratorium Course duration + 6 to 12 months grace period",
                "Interest Rates Competitive & Subsidy Options Available",
                "Collateral Optional (based on loan amount & course)",
              ].map((feature, idx) => (
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              Nihal Finserv — Investing in your education today, for a brighter
              tomorrow.
            </p>
