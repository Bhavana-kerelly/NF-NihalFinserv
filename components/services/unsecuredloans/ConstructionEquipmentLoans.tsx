...
import AnimatedWrapper from "@/components/AnimatedWrapper"; // ✅ shared wrapper
        ...
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-2xl font-bold mb-5">
              Build Bigger. Dig Deeper. Reach Higher – With the Right Financial
              Support.
            </h2>
            <p className="text-base mb-6">
              Construction demands precision, power, and the right equipment.
              Whether you're a contractor, builder, infrastructure developer, or
              EPC company, Nihal Finserv helps you finance heavy-duty
              construction equipment without hampering your cash flow.
            </p>
            <p className="text-base">
              From excavators to cranes, concrete mixers to road rollers — our
              Construction Equipment Loans are tailored to get your projects
              moving faster, more efficiently, and with ease.
            </p>
          </div>
        </section>
      </AnimatedWrapper>
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p>
                A Construction Equipment Loan is a type of asset-backed or
                unsecured loan offered to businesses or individuals to purchase,
                lease, or refinance heavy construction machinery. These loans
                help contractors and construction firms invest in both new and
                used equipment, with options to finance domestically manufactured
        ...
        <section className="bg-[#132b4a] text-white px-8 py-16">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {[
                "Loan Amounts from ₹5 Lakhs to ₹25 Crores",
                "Sanctions within 3–7 Working Days",
                "Up to 100% Equipment Financing",
                "Flexible Tenure – 1 to 7 Years",
                "Top-Up & Refinance Facility Available",
                "Funding Available for Imported Machines",
                "Competitive Interest Rates Based on Credit Profile",
                "Collateral-Free Options for Eligible Profiles",
              ].map((feature, idx) => (
