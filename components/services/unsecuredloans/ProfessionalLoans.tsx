...
import AnimatedWrapper from "@/components/AnimatedWrapper"; // ✅ shared animations
        ...
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base mb-6">
              Tailor-made finance solutions for doctors, chartered accountants,
              architects, engineers, lawyers, and other self-employed
              professionals.
            </p>
          </div>
        </section>
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p>
                Professional Loans are unsecured or secured loans designed
                specifically to meet the financial needs of qualified
                professionals. Whether you’re looking to set up a new practice,
                expand an existing one, invest in new technology, or manage
                working capital — Nihal Finserv helps you access the right
                financial tools with flexible terms and fast processing.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              Apply for a Professional Loan with Nihal Finserv and let your
              expertise take center stage — without financial hurdles.
            </p>
