          ...
          <Section animation="slideRight" delay={0.2}>
            <div className="w-full md:w-1/2">
              ...
              <p className="text-base mb-6">
                Need funds for business expansion, infrastructure development,
                equipment purchase, or working capital? Our Term Loans are
                designed to give you access to large-scale capital with fixed
                repayment schedules and flexible tenures that align with your
                financial goals.
              </p>
              <p>
                Whether you're a startup scaling operations or an established
                business pursuing long-term projects — we finance your ambition
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <Section animation="slideRight" delay={0.2}>
              <div className="text-gray-700 text-lg space-y-6">
                ...
                <p>
                  A Term Loan is a long- or short-duration loan provided for a
                  fixed amount, repayable in EMIs (Equated Monthly Installments)
                  over a set period. These loans help in funding significant
                  capital expenditures or long-term investments.
                </p>
              </div>
            </Section>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {[
                ...
                { title: "Repayment", desc: "Monthly/ Quarterly EMIs" },
                { title: "Tenure", desc: "1 year to 10 years" },
                { title: "Collateral", desc: "Secured or Unsecured options" },
                { title: "Interest Rates", desc: "Competitive, fixed/floating" },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
      ...
      <Section animation="scaleIn">
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            <h2 className="text-4xl font-bold text-center mb-6">Term Loans</h2>
