...
import AnimatedWrapper from "@/components/AnimatedWrapper"; // ✅ reusable animation wrapper
        ...
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base mb-6">
              Need funds but don’t want to liquidate your long-term investments?
              Nihal Finserv offers seamless Loan Against Securities (LAS),
              allowing you to leverage your existing portfolio while keeping
              your market exposure intact.
            </p>
            <p className="text-base mb-6">
              Whether it's for business expansion, personal needs, or managing
              cash flow — your shares, mutual funds, bonds, or insurance
              policies can be turned into instant liquidity.
            </p>
          </div>
        </section>
      </AnimatedWrapper>
            ...
            <div className="space-y-6">
              <div className="border border-gray-700 p-6">
                ...
                <p className="text-gray-400">
                  Retain ownership and potential capital gains on your
                  securities
                </p>
              </div>
              <div className="border border-gray-700 p-6">
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              The loan amount depends on the type and value of securities and
