        ...
        <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-2xl font-bold mb-5">
              Tailored Investment Solutions with Predictable Returns & Risk
              Control
            </h2>
            <p className="text-base mb-6">
              Looking to strike the perfect balance between risk and reward? With
              Structured Investments from Nihal Finserv, you gain access to a
              unique blend of debt security and equity upside — all designed
              around your financial goals and risk appetite.
            </p>
            <p className="text-base mb-6">
              Structured investments are ideal for high-net-worth individuals
              (HNIs), seasoned investors, or businesses seeking customized,
              market-linked growth solutions.
            </p>
          </div>
        </section>
      </AnimatedWrapper>
        ...
        <section className="w-full px-6 py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-gray-700 text-lg space-y-6">
              ...
              <p className="text-base mb-6">
                Structured investments are created using a combination of:
              </p>
              ...
              <p className="text-base mb-6">
                This mix allows for fixed income protection along with potential
                upside linked to market performance — without full equity risk
                exposure.
              </p>
            </div>
          </div>
        ...
        <section className="bg-white text-black py-16 px-6 md:px-20">
          <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
            ...
            <p className="text-center text-lg max-w-4xl mx-auto mb-14">
              Talk to our structured investment experts to build your customized
              portfolio today.
            </p>
