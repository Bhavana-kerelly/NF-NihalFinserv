          ...
          <Section animation="slideRight" delay={0.2}>
            <div className="w-full md:w-1/2">
              ...
              <p className="text-base mb-6">
                Need funds urgently for a short period? Whether it's a temporary cash crunch, 
                a business opportunity, or an emergency expense — Nihal Finserv offers Short-Term 
                Loans that are fast, flexible, and tailored for your immediate needs. 
                No long-term liabilities. Just quick, smart capital.
              </p>
            </div>
          </Section>
        </section>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <Section animation="slideRight" delay={0.2}>
              <div className="text-gray-700 text-lg space-y-6">
                ...
                <p>
                  A Short-Term Loan is a financing solution with a shorter repayment period — typically 
                  ranging from 3 months to 24 months. These loans are ideal for urgent requirements, 
                  seasonal business needs, working capital, or unexpected personal expenses.
                </p>
              </div>
            </Section>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <Section animation="slideRight" delay={0.2}>
              <div className="space-y-6">
                {[
                  { title: "Loan Amount", value: "₹50,000 to ₹50 Lakhs" },
                  { title: "Tenure", value: "3 months to 24 months" },
                  { title: "Repayment", value: "Weekly, Bi-weekly, or Monthly" },
                  { title: "Collateral", value: "Secured & Unsecured options available" },
                  { title: "Approval Time", value: "24–48 Hours" },
                  { title: "Interest Rates", value: "Competitive, based on profile and tenure." },
                ].map(({ title, value }) => (
                  <div key={title} className="border border-gray-700 p-6">
