    ...
    <>
      ...
      <section className="py-20 px-6 bg-[#132b4a] text-white flex flex-col md:flex-row items-center gap-10">
        ...
        >
          ...
          <p className="text-base mb-6">
            From freelancers and agencies to consultancies and facility management providers — we finance your growth.
          </p>
        </motion.div>
      </section>
      ...
      <section className="w-full px-6 py-12 md:py-20 bg-white">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="text-gray-700 text-lg space-y-6">
      ...
      <section className="bg-[#132b4a] text-white px-8 py-16">
        ...
        >
          ...
          <motion.div variants={staggerContainer} className="space-y-6">
            {[
              { title: "No Collateral Needed", desc: "Loans based on income & client profile" },
              { title: "Quick Approvals", desc: "Minimal paperwork, fast disbursal" },
              { title: "Tailored Loan Sizes", desc: "From ₹50,000 to ₹1 Crore" },
              { title: "Flexible Repayment", desc: "EMI, Bullet, or Project-based payments" },
              { title: "Support for GST-based Income", desc: "Leverage your service invoices to get funded" },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                variants={fadeUp}
      ...
      <section className="bg-[#f5f5f5] px-6 py-12 md:py-20 w-full">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="w-full rounded-xl overflow-hidden shadow-md">
            <Image
              src="/sme/SP3.jpg"
      ...
      <section className="bg-white text-black py-16 px-6 md:px-20">
        <motion.div
          ...
          variants={staggerContainer}
        >
          <motion.h2 variants={fadeUp} className="text-4xl font-bold text-center mb-6">
            Service Provider
          </motion.h2>
          <motion.p variants={fadeUp} className="text-center text-lg max-w-4xl mx-auto mb-14">
