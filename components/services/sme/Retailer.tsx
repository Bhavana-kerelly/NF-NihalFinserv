    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-base mb-6">
            Retail thrives on inventory, footfall, and quick cash flow. At Nihal
            Finserv, we provide easy, fast, and flexible loan solutions for
            retailers—whether you run a small kirana store, a boutique, or a
            chain of outlets.
          </p>
          <p className="text-base">
            Our financing helps you restock, expand, renovate, or handle
            day-to-day expenses smoothly. No stress, no delays — just
            ...
            {[
              {
                ...
                desc: "Loans based on income & turnover",
              },
              { title: "Quick Sanctions", desc: "Approvals within 48–72 hours" },
              {
                title: "Flexible Loan Amounts",
                desc: "₹50,000 – ₹50 Lakhs",
              },
              {
                title: "Easy Repayments",
                desc: "Choose from EMI, overdraft, or daily repayment models",
              },
              {
                title: "Retail-Focused Underwriting",
                desc: "Designed for sales-based businesses like yours",
              },
            ].map((f, i) => (
      ...
      >
        <div className="bg-[#132b4a] text-white mt-20 py-16 px-6 md:px-20">
          <h2 className="text-4xl font-bold text-center mb-6">Retailer</h2>
          <p className="text-center text-lg max-w-4xl mx-auto mb-14">
            Your store deserves more than just footfall — it needs financial
            fuel.
          </p>
